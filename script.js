document.addEventListener('DOMContentLoaded', () => {
    ...
    const projectsData = [
        ...
        { title: "Travel-Itinerary-Plus", image: "images/travel-itinerary.png", description: "A Gemini AI Powered Travel Intinerary app.", tags: ["TypeScript", "Nextjs", "HTML", "CSS", "Tailwind"], date: "2025-06-05", liveLink: "https://zealous-hill-011decf1e.6.azurestaticapps.net/", repoLink: "https://github.com/sujithmu/Travel-Itinerary-Plus" },
         { title: "Premier League Match Predictor", image: "images/Premier-League-Predictor-Pro.png", description: "A Streamlit web app using ML to predict Premier League match outcomes, deployed on Render.", tags: ["Python", "Streamlit"], date: "2025-10-06", liveLink: "https://portfolio-ebon-gamma-ohtl61ezmu.vercel.app/"}
    ];
